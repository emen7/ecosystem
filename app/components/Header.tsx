...
const Header: React.FC<HeaderProps> = ({ onMenuToggle, onSettingsToggle }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 bg-white dark:bg-gray-900 text-gray-800 dark:text-white shadow-md">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
          {/* Placeholder ALM Button */}
          <button
            onClick={() => alert('Almanac functionality will be implemented in the future.')}
            className="p-2 rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-gray-200 dark:hover:bg-gray-800"
            aria-label="Return to Almanac"
            title="Return to Almanac (Coming Soon)"
          >
